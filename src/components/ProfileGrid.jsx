...
export const ProfileGrid = ({ 
  ...
  const displayedProfiles = profiles.slice(startIdx, startIdx + PROFILES_PER_PAGE);
            ...
            {displayedProfiles.map((profile) => (
              <div key={profile._id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition transform hover:scale-105">
                ...
                <div className="p-4">
                  ...
                  <button onClick={() => onStartCall(profile)} className="w-full bg-gradient-to-r from-pink-400 to-purple-500 hover:from-pink-500 hover:to-purple-600 text-white py-2 rounded-lg font-semibold hover:shadow-lg transition flex items-center justify-center gap-2">
